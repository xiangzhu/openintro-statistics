...
source("~/GitHub/openintro-statistics/ch_distributions/figures/normalExamples/normalExamples-data.R")
source("~/GitHub/openintro-statistics/ch_distributions/figures/normalExamples/normalExamples-helpers.R")
