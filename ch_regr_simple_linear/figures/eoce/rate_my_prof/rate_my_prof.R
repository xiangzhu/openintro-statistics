...
prof_evals_beauty <- read.csv("~/GitHub/openintro-statistics/ch_regr_simple_linear/figures/eoce/rate_my_prof/prof_evals_beauty.csv")
...
#    cex.lab = 1.5, cex.axis = 1.5, las = 1, mfrow=c(2,2))
