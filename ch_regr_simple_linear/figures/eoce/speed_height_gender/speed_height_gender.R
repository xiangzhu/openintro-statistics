...
speed_survey <- read.csv("~/GitHub/openintro-statistics/ch_regr_simple_linear/figures/eoce/speed_height_gender/speed_survey.csv")
...
par(mar = c(3.7, 3.7, 0.5, 0.5), las = 1, mgp = c(2.5, 0.7, 0), 
    cex.lab = 1.25, cex.axis = 1.25, mfrow=c(1,2))
